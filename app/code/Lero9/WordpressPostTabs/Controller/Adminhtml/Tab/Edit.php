...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Lero9_WordpressPostTabs::tabs')
            ->addBreadcrumb(__('Wordpress Post Tabs'), __('Wordpress Post Tabs'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('wordpress_post_tab', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getLabel() : __('New Tab'));
